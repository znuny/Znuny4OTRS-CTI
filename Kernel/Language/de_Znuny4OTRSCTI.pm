...
sub Data {
    ...
    $Self->{Translation}->{"This configuration defines the regular expression for the CallerID."} = "Diese Konfiguration definiert den regulären Ausdruck für die CallerID.";
